from src.nfa_construction import NFA
import copy
...
def get_concat(a, b):
    ...
    # shift b's state/accept states/transition function
    shift(b, add)
    # merge b into a
    merge(a, b)
    return a
...
def get_regex_nfa(regex, indent=""):
    ...
    if len(regex) == 0:
        ...
        # apply implicit concatenation between the first character and the remaining characters
        return get_concat(
